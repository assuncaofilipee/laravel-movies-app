...
class ViewActorsTest extends TestCase
{
    ...
    {
        Http::fake([
            $this->tmdbUrl.'person/popular?page=1' => $this->fakePopularActors(),
        ]);
    ...
    /** @test */
    public function theIndexPage2ShowsTheCorrectInfo()
    {
        Http::fake([
            $this->tmdbUrl.'person/popular?page=2' => $this->fakePopularActorsPage2(),
        ]);
    ...
    /** @test */
    public function theActorPageShowsTheCorrectInfo()
    {
        Http::fake([
            $this->tmdbUrl.'person/2888' => $this->fakeActor(),
            $this->tmdbUrl.'person/2888/external_ids' => $this->fakeSocial(),
            $this->tmdbUrl.'person/2888/combined_credits' => $this->fakeCredits(),
        ]);
