...
class ActorViewModel extends ViewModel
{
    ...
    public function actor()
    {
        return collect($this->actor)->merge([
            ...
            'profile_path' => $this->actor['profile_path']
                ? getenv('TMDB_API_IMAGE_URL').'w300/'.$this->actor['profile_path']
    ...
    public function social()
    {
        return collect($this->social)->merge([
            'twitter' => $this->social['twitter_id'] ? getenv('TWITTER_URL').$this->social['twitter_id'] : null,
            'facebook' => $this->social['facebook_id'] ? getenv('FACEBOOK_URL').$this->social['facebook_id'] : null,
            'instagram' => $this->social['instagram_id'] ? getenv('INSTAGRAM_URL').$this->social['instagram_id'] : null,
        ])->only([
